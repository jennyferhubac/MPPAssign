...
public class DepartmentApplication
   ...
   public static void main(String[] args) throws IOException
      ...
      //*******************************************************
		...
		jacobBlack.myDefault(); //default method of the IPerson interface
		
		IPerson.myStatic(); // static method
		
		jacobBlack.myAbstract(); //abstract method
		
		//Lab7 question 10
		johnDoe.setStudentLevel(StudentLevel.FRESHMAN);
		maryJones.setStudentLevel(StudentLevel.SENIOR);
		leeJohnson.setStudentLevel(StudentLevel.JUNIOR);
		
		System.out.println(johnDoe);
		System.out.println(maryJones);
		System.out.println(leeJohnson);
		
		//Lab7 question 11
		MyImmutableClass myImmutableClass = new MyImmutableClass("Hello World!");
		
		System.out.println(myImmutableClass.getStrImmutable());
		/********************************************************************/
